...
import { getAccessToken } from "../auth"; // Adjust the relative path to your auth helper

// Define an interface for a leave request object
...
const EmployeeLeaveStatus: React.FC = () => {
  ...
  const fetchPendingRequests = async () => {
    ...
    try {
      ...
      const response = await axios.get("http://192.168.17.49:8000/api/leave-requests/myrequest/", {
